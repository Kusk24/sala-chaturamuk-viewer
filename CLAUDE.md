...
├── viewer/
│   ├── index.html
│   ├── reconstruction.html  # SEPARATE comparison page: the photogrammetry mesh (see amendment)
│   ├── vendor/              # three.js r128 UMD, vendored so reconstruction.html opens from file://
│   ├── model_*.js           # embedded GLB for reconstruction.html, generated (gitignored)
│   ├── app.js
